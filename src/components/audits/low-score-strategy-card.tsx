...
export function LowScoreStrategyCard({
  ...
  const recommendations: StrategyRecommendation[] = [
    {
      id: 'entity-coverage',
      category: 'Topical Entity Density',
      title: `Inject high-density category attributes to counter ${competitorA}`,
      description: `AI search engines cite competitors when users ask for "${queryText}" because competitor landing pages mention specific third-party testing metrics, fabric certifications, and sizing specifications that models synthesize as verified authority.`,
      expectedLift: '+18% SOV Lift',
      actionLabel: 'Generate Entity-Rich Content Blueprint',
      impactLevel: 'critical',
    },
    {
      id: 'schema-markup',
      category: 'Structured Schema',
      title: 'Deploy FAQPage & Product specification JSON-LD markup',
      description: `Perplexity and Google AI Overviews prioritize pages with structured JSON-LD entities. Adding authoritative FAQ markup to https://${domain} provides explicit conversational question-answer pairs for direct model extraction.`,
      expectedLift: '+14% SOV Lift',
      actionLabel: 'Generate JSON-LD Schema Script',
      impactLevel: 'high',
    },
    {
      id: 'referring-domains',
      category: 'Citation Sources',
      title: 'Recapture citations from editorial roundups & community forums',
      description: `Models currently ground their recommendations on articles from women's health reviews, Reddit discussion threads, and tech roundups where ${competitorA} and ${competitorB} maintain backlink prominence.`,
      expectedLift: '+12% SOV Lift',
      actionLabel: 'Draft Authority Roundup Outreach Pitch',
      impactLevel: 'medium',
    },
  ];
